...
const LandingPage = () => {
  return (
    <div className="relative w-screen h-screen flex-col justify-between bg-gray-50 text-black">
      ...
      <div className="hidden lg:block h-[280px] w-[515px] xl:h-[350px] xl:w-[625px] p-3 rounded-2xl absolute bg-white border top-[145px] right-10 xl:top-[145px] xl:right-20">
        <img
          src={AppFullDark}
      ...
      <div className="hidden md:block lg:hidden xl:block md:h-[300px] md:w-[220px] xl:h-[230px] xl:w-[180px] p-2 rounded-2xl  bg-[#0b6241] absolute md:top-[150px] md:right-48 xl:top-[355px] xl:right-40">
        <img
          src={AppMobileLight}
