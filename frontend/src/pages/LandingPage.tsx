...
const LandingPage = () => {
  ...
  return (
    <div className="relative w-screen h-screen flex-col justify-between bg-gray-50 text-black">
      ...
      <div className="hidden xl:block h-[350px] w-[625px] p-3 rounded-2xl absolute bg-white border top-[115px] right-20">
        <img
          src={AppFullDark}
      ...
      {/* bg-stone-800 */}
      <div className="hidden xl:block h-[230px] w-[180px] p-2 rounded-2xl  bg-[#0b6241] absolute xl:top-[325px] xl:right-40">
        <img
          src={AppMobileLight}
